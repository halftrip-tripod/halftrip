...
const _termsSections = [
  ...
  PolicySection('제4조 (계정)',
      '1. 서비스는 카카오·네이버 계정 연동 또는 아이디 기반 계정으로 가입할 수 있으며, 만 14세 미만은 가입할 수 없습니다.\n'
...
const _privacySections = [
  ...
  PolicySection('2. 처리하는 개인정보의 항목·목적·보유기간',
      '① 회원 관리 — 소셜 로그인 식별자(카카오·네이버 회원번호) 또는 아이디·비밀번호(일반 가입 시, 비밀번호는 일방향 암호화 저장), 이메일, 성명·전화번호(일반 가입 시), 거주지(시·군·구), 닉네임·프로필 설정 / 회원 탈퇴 시까지\n'
