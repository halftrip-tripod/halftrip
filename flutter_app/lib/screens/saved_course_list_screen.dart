...
class _SavedCourseListScreenState extends State<SavedCourseListScreen> {
  ...
  Future<void> _selectCourse(SavedCourse course) async {
    ...
    final payload = course.stops.asMap().entries.map((item) {
            ...
            : ListView(
                ...
                children: [
                  ...
                  for (final course in savedCourses) ...[
                    _CourseCard(
                      course: course,
                      selected: controller.selectedCourseIdForTrip(
                              widget.tripDetail.trip.id) ==
                          course.id,
...
class _CourseCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isYoutube = course.preferences.any((p) => p.contains('유튜브')) ||
